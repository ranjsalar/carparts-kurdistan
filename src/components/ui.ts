...
export const btnGhost = `${btnBase} px-3 py-2 text-steel-600 outline-brand-700 hover:bg-steel-100 hover:text-steel-900`;

export const btnDanger = `${btnBase} border border-steel-300 bg-white px-5 py-2.5 text-danger-600 outline-danger-600 hover:border-danger-600 hover:bg-danger-50`;

export const inputBase =
  "w-full rounded-lg border border-steel-300 bg-white px-3.5 py-2.5 text-body text-steel-900 placeholder:text-steel-400 transition-colors focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/15 disabled:bg-steel-100 disabled:text-steel-400";
